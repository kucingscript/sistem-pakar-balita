<x-app-layout>
                ...
                <form class="w-full" action="{{ route('admin.diagnoses.store') }}" method="post"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-4 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('patient_name') }}" name="patient_name"
                    ...
                    <div id="symptom-inputs">
                        <div class="symptom-group relative border border-gray-200 rounded pb-4 px-4">
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-full mb-6">
                                    <label
                                        class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase">Symptom
                                        Code*</label>
                                    <select name="symptoms[0][code]"
                                        ...
                                        @foreach ($symptoms as $symptom)
                                            <option value="{{ $symptom->code }}">{{ $symptom->code }} -
                                                {{ $symptom->description }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="w-full">
                                    <label
                                        ...
                                        Level*</label>
                                    <select name="symptoms[0][confidence]"
                                        class="block w-full px-4 py-3 bg-gray-200 border border-gray-200 text-gray-700 rounded focus:outline-none focus:bg-white focus:border-gray-500"
                                        required>
    ...
    <script>
        ...
        function addSymptomInput() {
            ...
            group.className = 'symptom-group relative border border-gray-200 rounded pb-4 px-4';
